package com.giraffe.tree.web.tree;

import com.alibaba.fastjson.JSON;
import com.fasterxml.jackson.annotation.JsonFormat;
import com.giraffe.tree.common.AjaxResult;
import com.giraffe.tree.common.PageDomain;
import com.giraffe.tree.common.TableDataInfo;
import com.giraffe.tree.common.TableSupport;
...
public class TreeTableController
{
    ...
    @GetMapping("/edit/{id}")
    public String edit(@PathVariable("id")Long id, UserTableModel model)
    {
    ...
    {
        System.err.println(JSON.toJSONString(userModel));
...
class UserTableModel
{
    ...
    public UserTableModel(Integer userId, String userCode, String userName, String userSex, String userPhone,
